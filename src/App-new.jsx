...
const mockConversations = [
  { id: 1, title: "About Me", preview: "Cybersecurity & AI student from Mosul" },
  { id: 2, title: "Projects", preview: "OYAPS Studio, NTU innovations, live websites" },
  { id: 3, title: "Skills & Experience", preview: "Full-stack, cybersecurity, AI/ML expertise" },
  { id: 4, title: "Contact Info", preview: "othman.yehiaa@gmail.com | Mosul, Iraq" },
];
...
const conversationMessages = {
  1: [ // About Me
    ...
    { 
      role: 'assistant', 
      content: "Hi! I'm Othman Yehia Hamed, a cybersecurity and AI engineering student from Mosul, Iraq. I'm passionate about advancing the tech scene in Iraq through innovation and community building.\n\n**📍 Basic Info:**\n• Location: Mosul, Iraq\n• Born: May 26, 2005\n• Education: B.Sc. in Cybersecurity and Cloud Computing Engineering\n• University: Northern Technical University\n\n**🎯 What I Do:**\n• Founder of OYAPS Studio (2023–Present)\n• Organizer of Ashur CTF 2025\n• Full-stack developer with cybersecurity expertise\n• AI/ML enthusiast and practitioner\n\n**💫 Mission:**\nI'm dedicated to building innovative tech solutions, training the next generation of developers, and putting Mosul on the tech map through competitions, education, and real-world projects that make a difference." 
    }
  ],
  2: [ // Projects
    { 
    ...
    { 
      role: 'assistant', 
      content: "Here are my key projects and achievements:\n\n**🏢 OYAPS Studio (2023–Present)**\n• Founded and lead a volunteer tech team\n• Deliver production systems for local businesses and universities\n• Organized Ashur CTF 2025 - largest cybersecurity competition in Nineveh governorate\n• Design and deliver AI and programming courses for children\n\n**🎓 University Innovation Projects (NTU)**\n• **NTU AI Chatbot:** Fine-tuned custom LLM to answer all university queries\n• **Scopus Gate:** Integrated Scopus API for auto research notifications\n• **Smart Scheduling System:** AI-powered class-schedule generator\n• **College Airport Display:** Real-time lecture display system\n• **NTU Exam System:** Full online exam platform with automated grading\n\n**🌐 Production Websites (Live)**\n• **Portfolio:** othman.oyaps.com\n• **Sunway Kindergarten Platform:** sunwayiq.com\n• **Simix Corporate Site:** simixiq.com\n• **AIOSH AI Learning Platform:** aiosh.oyaps.com\n• **Land of Franchise:** landoffranchise.iq\n• **Nukhbat Ninawa:** nukhbatninawa.com\n\n**🏆 Competition Achievements**\n• eJPT Certification (eLearnSecurity)\n• AI Competition Finalist - Cihan University\n• SulyCyberCon 2023 - 8th place nationwide\n• Iraq Ministry of Interior Cybersecurity - National finalist\n• Digital Shortcut Hackathon (Asiacell) - 3rd place\n• Hurry Up Hackathon - Winner (2025)" 
    }
  ],
  3: [ // Skills & Experience
    { 
        ...
        {role === 'assistant' && (
          <div className="avatar-container">
            <div className="assistant-avatar">
              <div className="avatar-inner">OH</div>
            </div>
          </div>
        )}
...
function ChatArea({ onToggleSidebar, sidebarCollapsed }) {
        ...
        <div className="header-main">
          ...
          <div className="header-right">
            ...
            <button className="profile-btn">
              <div className="profile-avatar">OH</div>
            </button>
          </div>
        </div>
      </div>
...
export default function App() {
  ...
  return (
    <div className={`app ${sidebarCollapsed ? 'sidebar-collapsed' : ''}`}>
      ...
      <ChatArea onToggleSidebar={toggleSidebar} sidebarCollapsed={sidebarCollapsed} />
    </div>
  );
}
